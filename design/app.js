...
// --- Recovery Banner ---
function dismissRecoverySuccess() {
  const banner = document.getElementById('recovery-success-banner')
  if (banner) banner.style.display = 'none'
}

function copyRecoverAddress() {
  const addr = document.getElementById('recover-address-text')
  const btn = document.getElementById('recover-copy-btn')
  if (!addr || !btn) return
